<div class="col-sm-12 col-md-4">
    <div class="card card-warning">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{route('dashboard.cms.landing.service-block.update', ['id' => $detail->id])}}">
            <div class="card-body">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    <label>Icon</label>
                    <input type="text" name="icon" value="{{$detail->icon}}" class="form-control" required placeholder="Nhập fontawesome icon">
                </div>
                <div class="form-group">
                    <label>Tiêu đề</label>
