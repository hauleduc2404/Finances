...
<section class="login-main">
  ...
  <section class="lm-body">
    ...
    <div class="lmb-choose">
      <div class="lmb-c-tab">
        <div class="text-upper text-color text-bold">đăng nhập</div>
        <div class="text-upper border-left-right main-bg-color text-bold"
             onclick="window.location.href = '{{route('finances.register')}}';">đăng ký
        </div>
      </div>
      ...
      <div class="lmb-c-btn main-bg-color text-upper text-bold" id="btn">đăng nhập</div>
    </div>
    {{-- <div class="lmb-tip">
  ...
  $("#btn").click(function () {
    ...
    $.post(
      ...
      function (data, state) {
        ...
        if (state != "success") {
          tishi('Lỗi hệ thống [LOGIN_00001]');
          return false;
