<div class="col-sm-12 col-md-4">
    <div class="card card-warning">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{route('dashboard.cms.landing.process.update', ['id' => $detail->id])}}">
            <div class="card-body">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    <label>Tiêu đề</label>
                    <input type="text" name="title" value="{{$detail->title}}" class="form-control" required placeholder="Nhập tên">
                </div>
                <div class="form-group">
                    <label>Nội dung</label>
                    <input type="text" name="content" value="{{$detail->content}}" class="form-control" required placeholder="Nhập vị trí">
                </div>
