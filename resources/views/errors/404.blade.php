...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="404.html#">
...
<div class="main-body">
    <div class="header">
        ...
        <a href="404.html#"> <i class="fab fa-facebook-f"></i>
        </a>
        <div class="divider"></div>
        <a href="404.html#"> <i class="fab fa-twitter"></i>
        </a>
